...
programa : lista_declaracoes		{ astreePrint($1,0); }	
	 ;
...
declaracao_vetores : 	tipo TK_IDENTIFIER '[' LIT_INTEGER ']'		{ $$ = astreeCreate(ASTREE_VETOR,$2,$1,astreeCreate(ASTREE_SYMBOL,$4,0,0,0,0),0,0);	}
			| tipo TK_IDENTIFIER '[' LIT_INTEGER ']' ':' ARRAYNUM	{ $$ = astreeCreate(ASTREE_VETOR_DECLARADO ,$2,$1,astreeCreate(ASTREE_SYMBOL,$4,0,0,0,0),0,0);	}
		   ;
