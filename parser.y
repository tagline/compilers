...
declaracao_vetores : 	tipo TK_IDENTIFIER '[' literais ']'		{ $$ = astreeCreate(ASTREE_VETOR_DECLARADO_1,$2,$1,$4,0,0);	}
		| tipo TK_IDENTIFIER '[' literais ']' ':' ARRAYNUM	{ $$ = astreeCreate(ASTREE_VETOR_DECLARADO_2,$2,$1,$4,$7,0);	}
		;
